                                    ...
                                    <div class="code-box-copy">
                                        <button class="code-box-copy__btn btn-clipboard"
                                            data-clipboard-target="#yearly-overview" title="Copy"><i
                                                class="icofont icofont-copy-alt"></i></button>
                                        <pre>
                                            <code class="language-html" id="yearly-overview"><div class="card income-card"> 
                                                <div class="card-header">
                                                    <div class="header-top d-sm-flex align-items-center">
                                                ...
                                                <table class="table table-bordernone">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-1.png"
                                                            ...
                                                            <td><img class="img-fluid"
                                                                    src="<?= base_url() ?>/assets/images/graph-1.png"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-2.png"
                                                                        alt data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid"
                                                                    src="<?= base_url() ?>/assets/images/graph-2.png"
                                                                    alt data-original-title title></td>
                                                            <td>
                                                                <p>$548526</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-3.png"
                                                                        alt data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid"
                                                                    src="<?= base_url() ?>/assets/images/graph-3.png"
                                                                    alt data-original-title title></td>
                                                            <td>
                                                                <p>$589565</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-4.png"
                                                                        alt data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid"
                                                                    src="<?= base_url() ?>/assets/images/graph-4.png"
                                                                    alt data-original-title title></td>
                                                            <td>
                                                                <p>$125424 </p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-5.png"
                                                                        alt data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid"
                                                                    src="<?= base_url() ?>/assets/images/graph-5.png"
                                                                    alt data-original-title title></td>
                                                            <td>
                                                                <p>$112103</p>
                                                            </td>
