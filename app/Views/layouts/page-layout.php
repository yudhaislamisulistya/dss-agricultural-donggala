        ...
        <div class="page-main-header">
            <div class="main-header-right row m-0">
                <div class="main-header-left">
                    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?= base_url() ?>/assets/images/logo.png" alt></a>
                    </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown"><i data-feather="message-square"></i>
                            <ul class="chat-dropdown onhover-show-div">
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= base_url() ?>/assets/images/4.jpg"
                                            alt>
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= base_url() ?>/assets/images/1.jpg"
                                            alt>
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= base_url() ?>/assets/images/2.jpg"
                                            alt>
        ...
        <div class="page-body-wrapper sidebar-icon">
            ...
            <header class="main-nav">
                <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i
                            data-feather="settings"></i></a><img class="img-90 rounded-circle" src="<?= base_url() ?>/assets/images/1.png" alt>
                            ...
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                                    ...
                                    <ul class="nav-submenu menu-content">
                                        ...
                                        <li><a class="submenu-title" href="javascript:void(0)">Tabs<span
                                ...
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                                    ...
                                    <ul class="nav-submenu menu-content">
                                        ...
                                        <li><a class="submenu-title" href="javascript:void(0)">Timeline<span
                                                    class="sub-arrow"><i class="fa fa-chevron-right"></i></span></a>
                                            <ul class="nav-sub-childmenu submenu-content">
                                ...
                                <li class="dropdown"><a class="nav-link menu-title link-nav"
                                        href="../starter-kit/index.html"><i data-feather="anchor"></i><span>Starter kit
                                        </span></a></li>
                                                ...
                                                <div class="col mega-box">
                                                    <div class="link-section">
                                                        ...
                                                        <div class="submenu-content opensubmegamenu">
                                                            <ul>
                                                                <li><a href="error-page1.html" target="_blank">Error
                                                                        page 1</a></li>
                                                                <li><a href="error-page2.html" target="_blank">Error
                                                                        page 2</a></li>
                                                                <li><a href="error-page3.html" target="_blank">Error
                                                                        page 3</a></li>
                                                                <li><a href="error-page4.html" target="_blank">Error
                                                                        page 4 </a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="submenu-content opensubmegamenu">
                                                            <ul>
                                                                <li><a href="login.html" target="_blank">Login
                                                                        Simple</a></li>
                                                                <li><a href="login_one.html" target="_blank">Login with
                                                                        bg image</a></li>
                                                                <li><a href="login_two.html" target="_blank">Login with
                                                                        image two </a></li>
                                                                ...
                                                                <li><a href="sign-up.html" target="_blank">Register
                                                                        Simple</a></li>
                                                                ...
                                                                <li><a href="forget-password.html">Forget Password</a>
                                                                </li>
                                                                <li><a href="creat-password.html">Creat Password</a>
                                                                </li>
                                                    ...
                                                    <div class="link-section">
                                                        ...
                                                        <div class="submenu-content opensubmegamenu">
                                                            <ul>
                                                                ...
                                                                <li><a href="comingsoon-bg-video.html">Coming with Bg
                                                                        video</a></li>
                                                                <li><a href="comingsoon-bg-img.html">Coming with Bg
                                                                        Image</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="link-section">
                                                        ...
                                                        <div class="submenu-content opensubmegamenu">
                                                            <ul>
                                                                ...
                                                                <li><a href="email-header.html">Basic With Header</a>
                                                                </li>
                                                                <li><a href="template-email.html">Ecomerce Template</a>
                                                                </li>
                                                                <li><a href="template-email-2.html">Email Template 2</a>
                                                                </li>
                                                                <li><a href="ecommerce-templates.html">Ecommerce
                                                                        Email</a></li>
                                                                <li><a href="email-order-success.html">Order Success
                                                                    </a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="header-top">
                                                <div class="setting-list bg-primary position-unset">
                                                    <ul class="list-unstyled setting-option">
                                                        ...
                                                        <li><i
                                                                class="icofont icofont-maximize full-card font-white"></i>
                                                        </li>
                                                        <li><i
                                                                class="icofont icofont-minus minimize-card font-white"></i>
                                                        </li>
                                                        <li><i
                                                                class="icofont icofont-refresh reload-card font-white"></i>
                                                        </li>
                                            ...
                                            <div class="header-top d-sm-flex align-items-center">
                                                ...
                                                <div class="center-content">
                                                    <p class="d-flex align-items-center"><i
                                                            class="toprightarrow-primary fa fa-arrow-up me-2"></i>80%
                                                        Growth</p>
                                                </div>
                                                <div class="setting-list">
                                                    <ul class="list-unstyled setting-option">
                                ...
                                <div class="col-xl-6 col-50 box-col-6 des-xl-50">
                                    <div class="card latest-update-sec">
                                            ...
                                            <div class="header-top d-sm-flex align-items-center">
                                                ...
                                                <div class="setting-list">
                                                    <ul class="list-unstyled setting-option">
                                                        ...
                                                        <li><i class="icofont icofont-error close-card font-primary">
                                                            </i></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media">
                                                                    ...
                                                                    <div class="media-body"><span>Google project Apply
                                                                            Review</span>
                                                            ...
                                                            <td>
                                                                <div class="media">
                                                                    <svg enable-background="new 0 0 512 512"
                                                                        ...
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                                                            d="m362 91v-60h-212v60h-150v390h512c0-16.889 0-372.29 0-390zm-182-30h152v30h-152zm302 390h-452v-202.844l90 36v46.844h90v-30h92v30h90v-46.844l90-36zm-302-150h-30v-60h30zm152-60h30v60h-30c0-7.259 0-52.693 0-60zm150-25.156-90 36v-40.844h-90v60h-92v-60h-90v40.844l-90-36c0-14.163 0-84.634 0-94.844h452z" />
                                                                    </svg>
                                                                    <div class="media-body"><span>Business Logo
                                                                            Create</span>
                                                                ...
                                                                <div class="media">
                                                                    <svg enable-background="new 0 0 512 512"
                                                                        ...
                                                                        <g>
                                                                            ...
                                                                            <path
                                                                                d="m256 62c8.284 0 15-6.716 15-15v-32c0-8.284-6.716-15-15-15s-15 6.716-15 15v32c0 8.284 6.716 15 15 15z" />
                                                                            <path
                                                                                d="m419.385 149.99 25.98-15c7.174-4.142 9.632-13.316 5.49-20.49-4.142-7.175-13.316-9.633-20.49-5.49l-25.98 15c-7.174 4.142-9.632 13.316-5.49 20.49 4.162 7.21 13.349 9.613 20.49 5.49z" />
                                                                            <path
                                                                                d="m92.615 304.01-25.98 15c-7.174 4.142-9.632 13.316-5.49 20.49 4.163 7.21 13.35 9.613 20.49 5.49l25.98-15c7.174-4.142 9.632-13.316 5.49-20.49-4.141-7.175-13.316-9.632-20.49-5.49z" />
                                                                            <path
                                                                                d="m338.5 84.105c7.141 4.124 16.33 1.716 20.49-5.49l15-25.98c4.142-7.174 1.684-16.348-5.49-20.49-7.174-4.144-16.349-1.685-20.49 5.49l-15 25.98c-4.142 7.175-1.684 16.348 5.49 20.49z" />
                                                                            <path
                                                                                d="m153.01 78.615c4.163 7.21 13.35 9.613 20.49 5.49 7.174-4.142 9.632-13.316 5.49-20.49l-15-25.98c-4.142-7.174-13.315-9.633-20.49-5.49-7.174 4.142-9.632 13.316-5.49 20.49z" />
                                                                            <path
                                                                                d="m445.365 319.01-25.98-15c-7.175-4.143-16.349-1.684-20.49 5.49-4.142 7.174-1.684 16.348 5.49 20.49l25.98 15c7.141 4.124 16.33 1.716 20.49-5.49 4.143-7.174 1.685-16.348-5.49-20.49z" />
                                                                            <path
                                                                                d="m107.615 124.01-25.98-15c-7.175-4.144-16.348-1.684-20.49 5.49s-1.684 16.348 5.49 20.49l25.98 15c7.141 4.124 16.33 1.716 20.49-5.49 4.143-7.174 1.685-16.348-5.49-20.49z" />
                                                                            <path
                                                                                d="m466 212h-30c-8.284 0-15 6.716-15 15s6.716 15 15 15h30c8.284 0 15-6.716 15-15s-6.716-15-15-15z" />
                                                                            <path
                                                                                d="m91 227c0-8.284-6.716-15-15-15h-30c-8.284 0-15 6.716-15 15s6.716 15 15 15h30c8.284 0 15-6.716 15-15z" />
                                                                            <path
                                                                                d="m275.394 216.394-19.394 19.393-19.394-19.393c-5.857-5.858-15.355-5.858-21.213 0s-5.858 15.355 0 21.213l25.607 25.606v53.787c0 8.284 6.716 15 15 15s15-6.716 15-15v-53.787l25.606-25.606c5.858-5.858 5.858-15.355 0-21.213-5.857-5.859-15.355-5.859-21.212 0z" />
                                                                        </g>
                                                                    </svg>
                                                                    <div class="media-body"><span>Business Project
                                                                            Research</span>
                                                                        <p>Due in 1 hour</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="media">
                                                                    <svg enable-background="new 0 0 512 512"
                                                                        ...
                                                                        <g>
                                                                            <path
                                                                                d="m512 390v-390h-512v390h241v32h-15c-41.355 0-75 33.645-75 75v15h210v-15c0-41.355-33.645-75-75-75h-15v-32zm-226 62c19.556 0 36.239 12.539 42.43 30h-144.86c6.191-17.461 22.874-30 42.43-30zm-256-92v-330h452v330c-12.164 0-438.947 0-452 0z" />
                                                                            <path
                                                                                d="m136 180c24.813 0 45-20.187 45-45s-20.187-45-45-45-45 20.187-45 45 20.187 45 45 45zm0-60c8.271 0 15 6.729 15 15s-6.729 15-15 15-15-6.729-15-15 6.729-15 15-15z" />
                                                                            <path
                                                                                d="m184.568 197.848c-28.678-24.39-60.953-16.827-61.054-16.833-35.639 5.799-62.514 38.985-62.514 77.196v41.789h150v-45c0-22.034-9.634-42.865-26.432-57.152zm-3.568 72.152h-90v-11.789c0-23.666 16.049-44.122 37.332-47.584 13.509-2.198 26.578 1.38 36.801 10.074 10.083 8.577 15.867 21.078 15.867 34.299z" />
                                                                            <path d="m241 270h120v30h-120z" />
                                                                            <path d="m241 210h210v30h-210z" />
                                                                            <path d="m241 150h210v30h-210z" />
                                                                            <path d="m331 90h120v30h-120z" />
                                                                            <path d="m241 90h60v30h-60z" />
                                                                            <path d="m391 270h60v30h-60z" />
                                                                        </g>
                                                                    </svg>
                                                                    <div class="media-body"><span>Recruitment in IT
                                                                            Depertment</span>
                                                                        <p>Complete in 3 Hours</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media">
                                                                    ...
                                                                    <div class="media-body"><span>Submit Riverfront
                                                                            Project</span>
                                                                        <p>Complete in 2 Days</p>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="code-box-copy">
                                                <button class="code-box-copy__btn btn-clipboard"
                                                    data-clipboard-target="#latest-update-sec" title="Copy"><i
                                                        class="icofont icofont-copy-alt"></i></button>
                ...
                <td>
                      <div class="media">
                           <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                             ...
                             <g>
                               <g>
                                 <path d="M491.96,449.94H38.788V42.667c0-10.712-8.682-19.394-19.394-19.394S0,31.955,0,42.667v426.667 c0,10.712,8.682,19.394,19.394,19.394H491.96c10.712,0,19.394-8.682,19.394-19.394C511.354,458.622,502.672,449.94,491.96,449.94z "/>
                               </g>
                             </g>
                             <g>
                               <g>
              ...
              <tr>
                <td>
                      <div class="media">
                          <svg enable-background="new 0 0 512 512" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                               <g>
                                 <path d="m345.622 126.038c-50.748-45.076-130.482-46.914-183.244 3.903-21.262 20.478-35.375 47.381-39.737 75.754-5.454 35.471 2.872 70.834 23.444 99.576 56.271 78.616 49.132 141.058 49.915 145.691 0 16.435 6.211 31.795 17.491 43.253 11.289 11.469 26.386 17.785 42.509 17.785 33.084 0 60-26.916 60-60 .686-4.269-6.11-72.81 47.676-143.691 17.875-23.557 27.324-51.673 27.324-81.309 0-38.547-16.54-75.347-45.378-100.962zm-89.622 355.962c-16.486 0-29.462-13.096-29.975-30h59.975c0 16.542-13.458 30-30 30zm83.777-191.826c-30.015 39.554-47.946 84.707-52.569 131.826h-62.57c-4.961-45.331-23.43-91.26-54.157-134.19-15.985-22.333-22.444-49.876-18.188-77.556 7.293-47.43 49.733-88.262 103.846-88.262 58.661 0 104.861 47.891 104.861 105.008 0 23.032-7.339 44.877-21.223 63.174z"/><br/><path d="m256 62c8.284 0 15-6.716 15-15v-32c0-8.284-6.716-15-15-15s-15 6.716-15 15v32c0 8.284 6.716 15 15 15z"/><br/><path d="m419.385 149.99 25.98-15c7.174-4.142 9.632-13.316 5.49-20.49-4.142-7.175-13.316-9.633-20.49-5.49l-25.98 15c-7.174 4.142-9.632 13.316-5.49 20.49 4.162 7.21 13.349 9.613 20.49 5.49z"/><br/><path d="m92.615 304.01-25.98 15c-7.174 4.142-9.632 13.316-5.49 20.49 4.163 7.21 13.35 9.613 20.49 5.49l25.98-15c7.174-4.142 9.632-13.316 5.49-20.49-4.141-7.175-13.316-9.632-20.49-5.49z"/><br/><path d="m338.5 84.105c7.141 4.124 16.33 1.716 20.49-5.49l15-25.98c4.142-7.174 1.684-16.348-5.49-20.49-7.174-4.144-16.349-1.685-20.49 5.49l-15 25.98c-4.142 7.175-1.684 16.348 5.49 20.49z"/><br/><path d="m153.01 78.615c4.163 7.21 13.35 9.613 20.49 5.49 7.174-4.142 9.632-13.316 5.49-20.49l-15-25.98c-4.142-7.174-13.315-9.633-20.49-5.49-7.174 4.142-9.632 13.316-5.49 20.49z"/><br/><path d="m445.365 319.01-25.98-15c-7.175-4.143-16.349-1.684-20.49 5.49-4.142 7.174-1.684 16.348 5.49 20.49l25.98 15c7.141 4.124 16.33 1.716 20.49-5.49 4.143-7.174 1.685-16.348-5.49-20.49z"/><br/><path d="m107.615 124.01-25.98-15c-7.175-4.144-16.348-1.684-20.49 5.49s-1.684 16.348 5.49 20.49l25.98 15c7.141 4.124 16.33 1.716 20.49-5.49 4.143-7.174 1.685-16.348-5.49-20.49z"/><br/><path d="m466 212h-30c-8.284 0-15 6.716-15 15s6.716 15 15 15h30c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/><br/><path d="m91 227c0-8.284-6.716-15-15-15h-30c-8.284 0-15 6.716-15 15s6.716 15 15 15h30c8.284 0 15-6.716 15-15z"/><br/><path d="m275.394 216.394-19.394 19.393-19.394-19.393c-5.857-5.858-15.355-5.858-21.213 0s-5.858 15.355 0 21.213l25.607 25.606v53.787c0 8.284 6.716 15 15 15s15-6.716 15-15v-53.787l25.606-25.606c5.858-5.858 5.858-15.355 0-21.213-5.857-5.859-15.355-5.859-21.212 0z"/>
                               </g>
                           </svg>
                        <div class="media-body">
                      ...
                      <div class="media">
                          <svg enable-background="new 0 0 512 512" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                               <g>
                                 ...
                                 <path d="m136 180c24.813 0 45-20.187 45-45s-20.187-45-45-45-45 20.187-45 45 20.187 45 45 45zm0-60c8.271 0 15 6.729 15 15s-6.729 15-15 15-15-6.729-15-15 6.729-15 15-15z"/><br/><path d="m184.568 197.848c-28.678-24.39-60.953-16.827-61.054-16.833-35.639 5.799-62.514 38.985-62.514 77.196v41.789h150v-45c0-22.034-9.634-42.865-26.432-57.152zm-3.568 72.152h-90v-11.789c0-23.666 16.049-44.122 37.332-47.584 13.509-2.198 26.578 1.38 36.801 10.074 10.083 8.577 15.867 21.078 15.867 34.299z"/>
                                 <path d="m241 270h120v30h-120z"/>
                                 <path d="m241 210h210v30h-210z"/>
                                 <path d="m241 150h210v30h-210z"/>
                                 <path d="m331 90h120v30h-120z"/>
                ...
                <td>
                      <div class="media">
                           <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                             ...
                             <g>
                               <g>
                                 <path d="M340.688,292.688L272,361.376V96h-32v265.376l-68.688-68.688l-22.624,22.624l96,96c3.12,3.12,7.216,4.688,11.312,4.688 s8.192-1.568,11.312-4.688l96-96L340.688,292.688z"/>
                               </g>
                             </g>
                           </svg>
                        <div class="media-body">
                                                ...
                                                <table class="table table-bordernone">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-1.png" alt
                                                            ...
                                                            <td><img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-1.png" alt
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-2.png" alt
                                                                        data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-2.png" alt
                                                                    data-original-title title></td>
                                                            <td>
                                                                <p>$548526</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-3.png" alt
                                                                        data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-3.png" alt
                                                                    data-original-title title></td>
                                                            <td>
                                                                <p>$589565</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-4.png" alt
                                                                        data-original-title title>
                                                                    <div class="media-body"><a
                                                                            href="product-page.html"><span>Marco M Kely
                                                                                Handbeg</span></a></div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td><img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-4.png" alt
                                                                    data-original-title title></td>
                                                            <td>
                                                                <p>$125424 </p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle"
                                                                        src="<?= base_url() ?>/assets/images/product-5.png" alt
                                                                        data-original-title title>
                                                                    <div class="media-body"><a
                                                            ...
                                                            <td><img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-5.png" alt
                                                                    data-original-title title></td>
                                                            <td>
                                                                <p>$112103</p>
                                                            </td>
     ...
     <table class="table table-bordernone">
       ...
       <tbody>
         <tr>
           <td>
             <div class="media">
               <img class="img-fluid rounded-circle" src="<?= base_url() ?>/assets/images/product-1.png" alt data-original-title title>
               <div class="media-body">
           ...
           <td>
             <img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-1.png" alt data-original-title title>
           </td>
           <td>
             <p>$210326</p>
           </td>
         ...
         <tr>
           <td>
             <div class="media">
               <img class="img-fluid rounded-circle" src="<?= base_url() ?>/assets/images/product-2.png" alt data-original-title title>
               <div class="media-body">
           ...
           <td>
             <img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-2.png" alt data-original-title title>
           </td>
           <td>
             <p>$548526</p>
           </td>
         ...
         <tr>
           <td>
             <div class="media">
               <img class="img-fluid rounded-circle" src="<?= base_url() ?>/assets/images/product-3.png" alt data-original-title title>
               <div class="media-body">
           ...
           <td>
             <img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-3.png" alt data-original-title title>
           </td>
           <td>
             <p>$589565</p>
           </td>
         ...
         <tr>
           <td>
             <div class="media">
               <img class="img-fluid rounded-circle" src="<?= base_url() ?>/assets/images/product-4.png" alt data-original-title title>
               <div class="media-body">
           ...
           <td>
             <img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-4.png" alt data-original-title title>
           </td>
           <td>
             <p>$125424 </p>
           </td>
         ...
         <tr>
           <td>
             <div class="media">
               <img class="img-fluid rounded-circle" src="<?= base_url() ?>/assets/images/product-5.png" alt data-original-title title>
               <div class="media-body">
           ...
           <td>
             <img class="img-fluid" src="<?= base_url() ?>/assets/images/graph-5.png" alt data-original-title title>
           </td>
           <td>
             <p>$112103</p>
           </td>
                                ...
                                <div class="col-xl-12 box-col-6 des-xl-50">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="code-box-copy">
                                                <button class="code-box-copy__btn btn-clipboard"
                                                    data-clipboard-target="#user-activations" title="Copy"><i
                                                        class="icofont icofont-copy-alt"></i></button>
                                ...
                                <div class="col-xl-12 box-col-6 des-xl-50">
                                    <div class="card trasaction-sec">
                                        <div class="card-header">
                                            <div class="header-top d-sm-flex align-items-center">
                                                ...
                                                <div class="setting-list">
                                                    <ul class="list-unstyled setting-option">
                                                        <li>
                                                            <div class="setting-secondary"><i class="icon-settings">
                                                                </i></div>
                                                        </li>
                                                        <li><i class="view-html fa fa-code font-secondary"></i></li>
                                                        <li><i
                                                                class="icofont icofont-maximize full-card font-secondary"></i>
                                                        </li>
                                                        <li><i
                                                                class="icofont icofont-minus minimize-card font-secondary"></i>
                                                        </li>
                                                        <li><i
                                                                class="icofont icofont-refresh reload-card font-secondary"></i>
                                                        </li>
                                                        <li><i
                                                                class="icofont icofont-error close-card font-secondary"></i>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="transaction-totalbal">
                                            <h2> $2,09,352k <span class="ms-3"> <a class="btn-arrow arrow-secondary"
                                                        href="javascript:void(0)"><i
                                                            class="toprightarrow-secondary fa fa-arrow-up me-2"></i>98.54%</a></span>
                                            </h2>
                                            <p>Total Balance</p>
                                        </div>
                                        <div class="card-body p-0">
